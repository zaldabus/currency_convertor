...
describe QuestionParser do
	...
	roman_convertor = RomanConvertor.new(roman_inputs)
	...
	currency_map = CurrencyMap.new(roman_convertor, currency_inputs)
	...
	subject(:question_parser) { QuestionParser.new(roman_convertor, currency_map, question_inputs) }
